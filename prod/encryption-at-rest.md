...
Combien de périphériques de bloc physiques apparaissent sur votre VM ?

Il se peut que vous deviez demander à l'administrateur du cloud (moi-même) de provisionner un volume de stockage pour vos données cryptées.
